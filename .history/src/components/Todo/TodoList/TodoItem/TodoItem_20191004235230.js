...
import { EDIT_DATA , FILL_DATA} from '../../../../actions/index'
import './TodoItem.css'
                        ...
                        <div className="card-header" role="tab" id="questionOne" >
                            <div className="row">
                                ...
                                <div className="col-sm-4">
                                    <button onClick={() => (editAction(item))} type="button" className="btn btn-primary">Sửa</button>
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        editAction: (item) => {
            dispatch({type: FILL_DATA, payload:item})
        }
    }
}
