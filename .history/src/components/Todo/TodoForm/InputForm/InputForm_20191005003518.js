...
class InputForm extends Component {
    ...
    changeInput = (e) => {
        ...
        this.props.title = 'input' === e._targetInst.elementType ? value : this.state.title,
        this.props.message = 'textarea' === e._targetInst.elementType ? value : this.state.message
                ...
                <div>
                    <div className="form-group row">
                        ...
                        <div className="col-sm-8">
                            <input type="title" value={ edit fillData.title} onChange={(e) => this.changeInput(e)} className="form-control" id="titleId" placeholder="title" />
                        </div>
                    </div>
                    <div className="form-group row">
